...
public class DatabaseUtils {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/stocks?autoReconnect=true&useSSL=false"; // had to set SSL to false in order for connection to work
